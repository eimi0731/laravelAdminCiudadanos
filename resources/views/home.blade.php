                            ...
                            <div class="col-md-4 col-xl-4">
                                <div style="background:  #fb9900; color:black;" class="card bg-c-pink order-card">
                                    <div class="card-block">
                                        ...
                                        @endphp
                                        @can('ver-Ciudadano')
                                        <h2 class="text-right"><i class="fa fa-users"
                                                aria-hidden="true"></i><span>{{$cant_personas}}</span></h2>
                                        <p class="m-b-0 text-right"><a href="/personas" class="text-white">Ver más</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
